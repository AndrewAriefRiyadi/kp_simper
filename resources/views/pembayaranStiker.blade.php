...
@section('content')
    <div class="flex flex-col gap-4 p-6 font-bold font-sans ">
        ...
        <h1 class=" text-lg">Nominal: Rp 150.000</h1>
        <form class="flex flex-col gap-4" action="/pengajuanstiker/{{$pstiker->id}}/pembayaran" method="POST" enctype="multipart/form-data">
            @csrf
